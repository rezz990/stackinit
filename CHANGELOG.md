...
- Added versioned `.stackinit.json` manifests and the `info` command.
- Added local, secret-safe project diagnostics through `doctor`.
- Added Node-compatible packaging, strict TypeScript checks, and automated tests.
